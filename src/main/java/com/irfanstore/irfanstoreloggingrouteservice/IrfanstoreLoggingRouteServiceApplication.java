package com.irfanstore.irfanstoreloggingrouteservice;
...
public class IrfanstoreLoggingRouteServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(IrfanstoreLoggingRouteServiceApplication.class, args);
	}
